...
use Australopithecus\MenuBundle\Entity\Menu;
use Australopithecus\MenuBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AustralopithecusMenuBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("AustralopithecusMenuBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AustralopithecusMenuBundle:Menu')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AustralopithecusMenuBundle:Menu:edit.html.twig")
     */
